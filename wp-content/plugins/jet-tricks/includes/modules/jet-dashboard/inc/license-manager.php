...
class License_Manager {
	...
	public function maybe_theme_core_license_exist() {
		...
		$jet_theme_core_license_sync = get_option( 'jet_theme_core_license_sync', 'false' );
		...
		update_option( 'jet_theme_core_license_sync', 'true' );
		...
		if ( 'error' === $responce['status'] ) {
			wp_send_json(
				array(
					...
					'data'    => isset( $responce['data'] ) ? isset( $responce['data'] ) : [],
				)
			);
		}
