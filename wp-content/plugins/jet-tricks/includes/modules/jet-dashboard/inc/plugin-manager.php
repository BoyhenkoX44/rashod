...
class Plugin_Manager {
	...
	public function plugin_row_meta( $plugin_meta, $plugin_file, $plugin_data ) {
		...
		if ( array_key_exists( $plugin_file, $this->registered_plugins_data ) && ( isset( $plugin_data['update'] ) && $plugin_data['update'] ) ) {

			$plugin_meta[2] = sprintf( '<a href="%s" class="thickbox open-plugin-details-modal" aria-label="%s" data-title="%s">%s</a>',
