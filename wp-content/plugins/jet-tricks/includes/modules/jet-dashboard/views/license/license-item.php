...
>
	...
	>
		...
		<span v-if="isLicenseActive">Congratulations!<br/>Your licence has been activated!</span>
	</div>
	...
	>
		...
		<div class="license-details__fields">
			...
			<div class="cx-vui-alert info-type">
				...
				<div class="cx-vui-alert__message">This license will activate licenses for all included plugins of this set</div>
			</div>
