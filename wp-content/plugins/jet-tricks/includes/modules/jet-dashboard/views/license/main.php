<div class="jet-dashboard-license-page">
	...
	<transition name="popup">
		...
		>
			...
			<div slot="content">
				<p>Your license is included in several packages. Its deactivation in one of them disables the license in the rest of the plugins. You can manage it via License Manager</p>
				<cx-vui-button
