	...
	public function _register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} .jet-color-image-list__input:checked +' . $css_scheme['decorator'] . ' > *' => 'border-color: {{VALUE}}',
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .jet-color-image-list__input:checked ~' . $css_scheme['label'] => 'color: {{VALUE}}',
				),
			)
		);
