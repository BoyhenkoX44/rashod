...
class Boldgrid_Backup_Premium_Admin_Remote_Google_Drive_Hooks {
	 ...
	 *
	 * When you go to the BoldGrid Backup settings page and see a list of storage providers, each of
	 * those storage providers needs to hook into the "boldgrid_backup_register_storage_location"
	 * filter and add themselves.
	 *
	 * @since 1.1.0
	 *
			...
			$this->core->notice->add_user_notice(
				wp_kses(
					sprintf(
						...
						__(
							'<h2>BoldGrid Backup Premium - Google Drive Download</h2><p>Backup file <strong>%1$s</strong> successfully downloaded from Google Drive.</p>',
							'boldgrid-backup'
						),
						$filename
					), $allowed_html
