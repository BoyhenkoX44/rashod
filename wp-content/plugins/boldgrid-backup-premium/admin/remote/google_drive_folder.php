...
class Boldgrid_Backup_Premium_Admin_Remote_Google_Drive_Folder {
	 ...
	 *
	 * All backups will be stored off the root in a folder named 'BoldGrid Backup', such as:
	 * /BoldGrid Backup/DomainA.com/backup1.zip
	 * /BoldGrid Backup/DomainB.com/backup1.zip
	 *
	 * @since 1.1.0
	 * @access private
	 * @var string
