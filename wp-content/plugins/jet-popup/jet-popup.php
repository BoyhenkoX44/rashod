	...
	class Jet_Popup {
		...
		public function init() {
			...
			if ( is_admin() ) {
				...
				require $this->plugin_path( 'includes/updater/class-jet-popup-plugin-changelog.php' );

				jet_popup_plugin_changelog()->init( array(
					'name'     => 'JetPopup',
					'slug'     => 'jet-popup',
					'version'  => $this->get_version(),
					'author'   => 'Zemez',
					'homepage' => 'https://crocoblock.com/plugins/jetpopup/',
					'banners'  => array(
						'high' => $this->plugin_url( 'assets/image/banner.png' ),
						'low'  => $this->plugin_url( 'assets/image/banner.png' ),
					),
				) );
