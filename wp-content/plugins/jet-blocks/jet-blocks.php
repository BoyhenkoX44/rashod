	...
	class Jet_Blocks {
		...
		public function init() {
			...
			if ( is_admin() ) {
				...
				require $this->plugin_path( 'includes/updater/class-jet-blocks-plugin-changelog.php' );

				jet_blocks_plugin_changelog()->init( array(
					'name'     => 'JetBlocks For Elementor',
					'slug'     => 'jet-blocks',
					'version'  => $this->get_version(),
					'author'   => 'Zemez',
					'homepage' => 'https://crocoblock.com/plugins/jetblocks/',
					'banners'  => array(
