			...
			$this->builder->register_settings(
				array(
					'general_options' => array(
						...
						'title'  => esc_html__( 'General', 'jet-blocks' ),
					),
				)
			);
			...
			$this->builder->register_control(
				array(
					'widgets_load_level' => array(
						...
						'title'       => esc_html__( 'Editor Load Level', 'jet-blocks' ),
						'description' => esc_html__( 'Choose a certain set of options in the widget’s Style tab by moving the slider, and improve your Elementor editor performance by selecting appropriate style settings fill level (from None to Full level)', 'jet-blocks' ),
					),
				)
			);
